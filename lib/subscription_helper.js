...
var postSub = function (msg, callback) {
   ...
   dbc.conditionalHasMember(subscription, 'endpoint', (subscription.type.toLowerCase() === 'notification' || subscription.type.toLowerCase() === 'gcm') )
...
var getSubscriptions = function (msg) {
   ...
   logger.log('info', 'Subscription query range: ' + params.startkey+' '+params.endkey);
